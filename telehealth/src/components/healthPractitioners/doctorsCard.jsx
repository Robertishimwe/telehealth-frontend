...
function DoctorsCard({DoctorName,Specialization,id,workPlace,email,bio,profilePicture}) {
  return (
    <>
      <div className="team-item" style={{width:'46%', marginBottom:10, marginTop:20}}>
        <div className="row g-0 bg-light rounded overflow-hidden">
          <div className="col-12 col-sm-5 h-100">
            <img className="img-fluid h-100" src={profilePicture ?`${profilePicture}` : "img/team-2.jpg"} style={{ objectFit: 'cover' }} />
          </div>
